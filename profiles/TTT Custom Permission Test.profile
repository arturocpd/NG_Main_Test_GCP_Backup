...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.Prod_field_1__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.Prod_field_2__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>SchedulingConstraint-Formato Restricción de programación</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>SchedulingObjective-Formato Objetivo de programación</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>SchedulingRule-Formato Regla de programación</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ServiceResourcePreference-Formato Preferencia de recurso de servicio</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ShiftSchedulingOperation-Formato Operación de programación de turnos</layout>
    </layoutAssignments>
    <layoutAssignments>
